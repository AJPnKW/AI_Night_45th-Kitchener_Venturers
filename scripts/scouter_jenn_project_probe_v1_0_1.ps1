...
File: scouter_jenn_project_probe_v1_0_1.ps1
Version: 1.0.1
...
Save-TextFile -Path (Join-Path $compareRoot 'inventory_compare_summary.json') -Content ($summary | ConvertTo-Json -Depth 5)
