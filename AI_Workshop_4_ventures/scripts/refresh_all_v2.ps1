...
<#
[CAPABILITY] ai_workshop_refresh_v2=YES
Runs:
- download_public_references_v2.ps1
- generate_folder_manifest.ps1
- opens start_here.html
#>
...
$log_path = Join-Path $log_dir "refresh_all_v2_$timestamp.log.txt"
...
$download_script = Join-Path $script_dir 'download_public_references_v2.ps1'
